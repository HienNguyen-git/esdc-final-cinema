...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2022 at 06:52 PM
...
--
-- Table structure for table `foodbill`
--

CREATE TABLE `foodbill` (
  `idfoodbill` int(11) NOT NULL,
  `idVe` int(11) NOT NULL,
...
(17, '12:00:00', '2022-05-19', 5, 2, '[61,62]'),
(18, '15:00:00', '2022-05-19', 5, 2, '[]'),
(19, '09:00:00', '2022-05-20', 5, 2, '[]'),
(20, '12:00:00', '2022-05-20', 5, 2, '[]'),
(21, '15:00:00', '2022-05-20', 5, 2, '[115,117,118,98,97,71,72,101,103,78,79,105,106,108,109,39,40,46,48,69,70,52,54,33,36,26,27,56,63,64]'),
(22, '09:00:00', '2022-05-18', 1, 1, '[88,89,123,124,202,203]'),
...
(29, '15:00:00', '2022-05-19', 1, 1, '[108,109,64,65]'),
...
(1, 90000, 0, 29, 1, 'F14,F15'),
(3, 90000, 0, 21, 1, 'H11,H13,H14'),
(4, 90000, 0, 21, 1, 'I11'),
(5, 90000, 0, 21, 1, 'I11'),
(6, 90000, 0, 21, 1, 'I11'),
(7, 90000, 0, 21, 1, 'I10'),
(8, 90000, 0, 21, 1, 'G6,G7'),
(9, 90000, 0, 21, 1, 'I6,I7'),
(10, 90000, 0, 21, 1, 'J3,J5'),
(11, 90000, 0, 21, 1, 'H2,H3'),
(12, 90000, 0, 21, 1, 'J7,J8'),
(13, 90000, 0, 21, 1, 'J7,J8'),
(14, 90000, 0, 21, 1, 'J10,J11'),
(15, 90000, 0, 21, 1, 'D7,D8'),
(16, 90000, 0, 21, 1, 'E3,E5'),
(17, 90000, 0, 21, 1, 'G4,G5'),
(18, 90000, 0, 21, 1, 'E9,E11'),
(19, 90000, 0, 21, 1, 'D1,D4'),
(20, 90000, 0, 21, 1, 'C5,C6'),
(21, 90000, 0, 21, 1, 'F2'),
(22, 90000, 0, 21, 1, 'F9,F10'),
(23, 90000, 0, 21, 1, 'G10,G11'),
(24, 90000, 0, 21, 1, 'B3,B4'),
(25, 90000, 0, 21, 1, 'A3,A4'),
(26, 90000, 0, 22, 1, 'I11,I12'),
(27, 90000, 0, 22, 1, 'J16'),
(28, 90000, 0, 22, 1, 'F15,F16'),
(29, 90000, 0, 22, 1, 'F15,F16'),
(30, 90000, 0, 22, 1, 'J7,J9'),
(31, 90000, 0, 22, 1, 'K11,K12'),
(32, 90000, 0, 22, 1, 'H3,H4'),
(33, 90000, 0, 22, 1, 'G10,G11'),
(34, 90000, 0, 22, 1, 'J10,J11'),
(35, 90000, 0, 22, 1, 'K3,K4'),
(36, 90000, 0, 22, 1, 'H7,H8'),
(37, 90000, 0, 22, 1, 'G7,G8'),
(38, 90000, 0, 22, 1, 'G7,G8'),
(39, 90000, 0, 22, 1, 'K7,K8'),
(40, 90000, 0, 22, 1, 'K7,K8'),
(41, 90000, 0, 22, 1, 'K9,K10'),
(42, 90000, 0, 22, 1, 'D9,D10'),
(43, 90000, 0, 22, 1, 'K5,K6'),
(44, 90000, 0, 22, 1, 'H6,H7'),
(45, 90000, 0, 22, 1, 'J10,J11'),
(46, 90000, 0, 22, 1, 'J8,J9'),
(47, 90000, 0, 22, 1, 'J8,J9'),
(48, 90000, 0, 22, 1, 'K8,K9'),
(49, 90000, 0, 22, 1, 'K15,K16'),
(50, 90000, 0, 22, 1, 'K15,K16'),
(51, 90000, 0, 22, 1, 'I12,I13'),
(52, 90000, 0, 22, 1, 'H12,H13'),
(53, 90000, 0, 22, 1, 'J13,J14'),
(54, 90000, 0, 22, 1, 'J13,J14'),
(55, 90000, 0, 22, 1, 'H17,H18'),
(56, 90000, 0, 22, 1, 'J17,J18'),
(57, 90000, 0, 22, 1, 'J17,J18'),
(58, 90000, 0, 22, 1, 'F14,F15'),
(59, 90000, 0, 22, 1, 'E13,E14'),
(60, 90000, 0, 22, 1, 'G10,G11'),
(61, 90000, 0, 22, 1, 'K13,K14'),
(62, 90000, 0, 17, 1, 'F7,F8');
...
--
-- Indexes for table `foodbill`
--
ALTER TABLE `foodbill`
  ADD PRIMARY KEY (`idfoodbill`);
...
--
ALTER TABLE `billdetail`
  MODIFY `idbilldetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT for table `foodbill`
--
ALTER TABLE `foodbill`
  MODIFY `idfoodbill` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `showtime`
  MODIFY `idsuatchieu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT for table `ticket`
--
ALTER TABLE `ticket`
  MODIFY `idve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
COMMIT;
